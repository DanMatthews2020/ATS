...
router.post('/',      authenticate, requirePermission('job:write'), validate(CreateJobSchema), jobsController.createJob);
...
router.patch('/:id/stages/:stageId/scorecard', authenticate, jobsController.updateStageScorecard);
router.get('/:id/applications',          authenticate, jobsController.getJobApplications);
router.get('/:id/applications/archived', authenticate, jobsController.getArchivedApplications);
...
router.patch('/:id',                 authenticate, requirePermission('job:write'), jobsController.updateJob);
router.delete('/:id',                authenticate, requirePermission('job:write'), jobsController.deleteJob);
